...
const Header: React.FC = () => {
  return (
    <header className="bg-black/80 backdrop-blur-sm sticky top-0 z-50 shadow-lg shadow-black/20 border-b border-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 md:h-24">
          <Logo />
          <h1 className="hidden sm:block text-center text-xl md:text-2xl lg:text-3xl font-bold text-gray-200 tracking-wider px-4">
            AGENDAMENTOS FIGHTZONE 017
          </h1>
          <a
            href="https://www.instagram.com/fightzone017/"
            target="_blank"
